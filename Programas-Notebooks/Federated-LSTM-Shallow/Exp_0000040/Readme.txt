Como visto acima os resultados ficaram bons, mas a parte de congestionamento 02 merece alguma otimização. 
Agora vamos fazer uma mudança nos pesos das médias, deslocando a relevância para a medida atual. 
Outra coisa que foi pensada é a eliminação do filtro das inconsistências no ns3, já 
que está sendo feita no python, com base na leiturna no roteador. Vamos fazer uma rodada com 60/100.
