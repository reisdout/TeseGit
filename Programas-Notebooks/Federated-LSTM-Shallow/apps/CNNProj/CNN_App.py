from CNNTerminal import CNNTerminal
...
if(treino == True):
    ...
    basePath = '../../Exp_0000068_20F_BBR' #Para se montar a lista com os arquivos da base. No caso de treinameno, geralmente e a mesma do experiment path
    experimentPath = '../../Exp_0000068_20F_BBR'  #Diretorio do experimento. Tem a conotaçao de registrar as saidas do experimento (graficos, por exemplo)
    modelPath =  "../../Exp_0000055" #De onde se deve carregar um modelo em caso de aderencia. No caso de treinamento, pode ser o experimentPath, uma vez que nao carrega modelo algum



objTerminal = CNNTerminal(basePath, experimentPath, modelPath, parTreino=treino,parLstTrainFeatures=[1,2,3])
